...
public class SampleIterator {
    ...
    public static void main(String[] args) {
        ...
        showList(x,li); 
        System.out.println("Move 3 - removing last thing travelled next over " );
        li.remove();
        showList(x,li); 
        ...
        showList(x,li); 
         System.out.println("Move 7 - removing last thing travelled next over " );
        li.remove();
        showList(x,li); 
        ...
        showList(x,li); 
         System.out.println("Move 14 will cause error- cant go next if at end of list");
        try{
          li.next();
        }catch(Exception e){
            System.out.println(e);
    ...
    public static void showList(ArrayList list, ListIterator it){
        for (int i = 0; i < list.size(); i++) {
                if(it.hasPrevious()==false&& i==0)System.out.print("*|");
            System.out.print(list.get(i) + "|");
            if(i==it.previousIndex())System.out.print("*|");
